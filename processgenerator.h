...
public:
  ...
  static QString generateProcessCodeWithBehavior(
  ...
  static QString
  generateIncludesSection(const QVector<EntityInstance> &entities);

  // Generate ALL process definitions inline (to avoid include issues)
  static QString
  generateAllProcessesCode(const QVector<EntityInstance> &entities,
                           const QString &wrapperOpen = "",
                           const QString &wrapperClose = "");

  // Generate declarations section (DECLARE PROCESS ...)
  static QString
  generateDeclarationsSection(const QVector<EntityInstance> &entities);
  ...
  static bool saveProcessFile(const QString &projectPath,
                              const QString &processName, const QString &code);

  // Get unique process names from entities
  static QStringList
  getUniqueProcessNames(const QVector<EntityInstance> &entities);
  ...
  static QString generateGraphCode(const EntityInstance &entity,
